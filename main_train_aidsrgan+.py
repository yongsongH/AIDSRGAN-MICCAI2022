...
def main(json_path='options/train_enhance_msrresnet_denosing_add_deloss_rcagroup.json'):
    '''
    # ----------------------------------------
    # Step--1 (prepare opt)
    # ----------------------------------------
    ...
    G_state_dict = torch.load(
        'superresolution/train_deloss_l1__RCAgroup_x2_0209/models/215000_G.pth')
    D_state_dict = torch.load(
        'superresolution/train_deloss_l1__RCAgroup_x2_0209/models/215000_D.pth')
